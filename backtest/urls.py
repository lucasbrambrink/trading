...
urlpatterns = patterns('',
    ...
    url(r'^assets/(?P<backtest_uuid>[0-9a-zA-Z]{32})/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/(?P<day>[0-9]{1,2})', AssetsDateList.as_view(), name='asset_date_list'),
    url(r'^risks/(?P<backtest_uuid>[0-9a-zA-Z]{32})/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/(?P<day>[0-9]{1,2})', RiskMetricsDateList.as_view(), name='riskmetrics_date_list'),
