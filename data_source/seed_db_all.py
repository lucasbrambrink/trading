...
ticker_csv = '../csv/symbols.csv'

# CSV file storing all stock prices
prices_csv = '../csv/prices.csv'
spy_csv = '../csv/spy_prices.csv'
yields_csv = '../csv/risk_free_yields.csv'
...
def seed_ratios():
    ...
    with open(ratio_csv, newline='') as ratios:
        ...
        for row in data_reader:
            ...
            Ratios.objects.create(
                stock=stock,'CASH_REV','EV_EBITDA','MKT_CAP','PE_CURR','ROE'
                date=row['Date'],
